...
import styles from "./our-misson.module.scss";
    ...
    <section className={`${styles.container} panel`} data-color="white">
      ...
      <div className={styles.about}>
        <div className={styles.box}>
          <Icons.BiBullseye className={styles.icon} />
        ...
        <div className={styles.box}>
          <Icons.FiEye className={styles.icon} />
        ...
        <div className={styles.box}>
          <Icons.IoConstructOutline className={styles.icon} />
