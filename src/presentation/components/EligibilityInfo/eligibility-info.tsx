import styles from "./eligibility-info.module.scss";
    ...
    <section className={styles.container}>
      <div className={styles["text-section"]}>
        ...
        <h1 className={styles.title}>
          Por que contratar o Empréstimo Consignado da América Financeira?
        </h1>
      ...
      <div className={styles["benefits-section"]}>
        <div className={styles["box"]}>
          ...
          <p className={styles.paragraph}>
            Taxas até 3x menores quando comparadas com outros tipos de
            empréstimo.
          </p>
        </div>
        <div className={styles["box"]}>
          ...
          <p className={styles.paragraph}>
            Todo o processo é 100% online. Contrate da sua casa pelo site ou com
            umas das atendentes.
          </p>
        </div>
        <div className={styles["box"]}>
          ...
          <p className={styles.paragraph}>
            Assim que aprovado, seu Empréstimo Conisnado cai rápido na sua
            conta.
          </p>
        </div>
        <div className={styles["box"]}>
          ...
          <p className={styles.paragraph}>
            As parcelas são descontadas diretamente da sua folha de pagamento em
            até 84x.q
          </p>
        </div>
      </div>
