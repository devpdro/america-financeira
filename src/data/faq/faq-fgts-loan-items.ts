const FaqFgtsLoanItems = [
  ...
  },
  {
    ...
    answer:
      "Trabalhadores com saldo disponível nas contas do FGTS, seja em contas ativas ou inativas.",
  },
  {
    question:
      "Quais são os documentos necessários para solicitar o Empréstimo FGTS?",
    answer:
      "Documento de identidade com foto (RG ou CNH), CPF, comprovante de residência e extrato do FGTS.",
  },
  {
    question: "Qual o valor máximo que posso antecipar com o Empréstimo FGTS?",
    answer:
      "O valor máximo depende do saldo disponível nas contas do FGTS e das políticas da instituição financeira.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "O pagamento é feito através do saldo do FGTS disponível, descontado diretamente das contas do FGTS.",
  },
  {
    question:
      "É possível antecipar o saque-aniversário do FGTS com este empréstimo?",
    answer:
      "Sim, é possível antecipar o saque-aniversário do FGTS, recebendo o valor antecipadamente.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sim, o valor antecipado pode ser utilizado conforme a necessidade do solicitante.",
  },
  {
...
export default FaqFgtsLoanItems;
