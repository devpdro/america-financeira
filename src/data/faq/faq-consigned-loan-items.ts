const FaqConsignedLoanItems = [
  ...
  {
    question:
      "Existe um limite de idade para contratar um Empréstimo Consignado?",
    answer:
      "Sim, geralmente a idade máxima é de 80 anos, mas pode variar de acordo com a instituição financeira.",
  },
  {
  ...
  {
    question:
      "O que acontece se eu perder o emprego durante o pagamento do Empréstimo Consignado?",
    answer:
      "As parcelas continuarão a ser cobradas, mas o pagamento poderá ser renegociado diretamente com o banco.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sim, é possível quitar o empréstimo antecipadamente, e você pode obter desconto nos juros futuros.",
  },
  {
...
export default FaqConsignedLoanItems;
