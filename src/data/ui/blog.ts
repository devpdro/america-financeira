...
export const blogArticle = [
  ...
  },
  {
    ...
    listOne: ' Pode ajudar a organizar suas finanças em situações emergenciais.',
    titleListTwo: 'Desvantagens:',
    listTwo: ' Taxas de juros podem ser altas. Avalie se realmente é necessário.',
    titleConclusion: 'Conclusão:',
    paragraphThree:
  ...
  },
  {
    ...
    listTwo: ' Pagamento descontado diretamente da folha, sem preocupação de atrasos.',
